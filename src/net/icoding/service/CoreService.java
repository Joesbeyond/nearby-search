...
import net.icoding.message.resp.Article;
import net.icoding.message.resp.NewsMessage;
import net.icoding.message.resp.TextMessage;
import net.icoding.pojo.BaiduPlace;
import net.icoding.pojo.UserLocation;
import net.icoding.util.BaiduMapUtil;
import net.icoding.util.MessageUtil;
import net.icoding.util.MySQLUtil;
